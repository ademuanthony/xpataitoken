...
contract XPatAi is BaseErc20, AntiSniper, Burnable, Taxable {

    mapping(address => bool) public zkManualEnable;
    uint256 public zkTokenThreshold;

    constructor () {
        configure(0x9dF336BCf2B5BDb4F4dD854e539853F3a25A3C96);
        ...
        minimumTokensBeforeSwap = 21000 * 10 ** decimals;
        excludedFromTax[address(taxDistributor)] = true;
        taxDistributor.createWalletTax("Listing", 190, 456, 0xE6fb6350f3b70C63b764e9E678DB8e13CdD3fD72, true);
        taxDistributor.createWalletTax("Marketing", 185, 444, 0x28c47Ee37f1A358bCB55365Aa3F155EEf5A7f25D, true);
        taxDistributor.createWalletTax("Dev", 125, 300, 0x9dF336BCf2B5BDb4F4dD854e539853F3a25A3C96, true);
        autoSwapTax = false;
        ...
        zkTokenThreshold = 210_000 * 10 ** decimals;

        // Finalise
        _allowed[address(taxDistributor)][routerAddress] = 2**256 - 1;
        _totalSupply = _totalSupply + (21_000_000 * 10 ** decimals);
